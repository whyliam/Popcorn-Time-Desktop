...
## ./make_popcorn.sh '-b release/0.3.4 https://github.com/liszd/Popcorn-Time-Desktop'
##


clone_repo="True"
if [ -z "$1" ]; then
    clone_url="https://github.com/liszd/Popcorn-Time-Desktop.git"
elif [ "$1" = "ssh" ]; then
    clone_url="git@github.com:liszd/Popcorn-Time-Desktop.git"
else
    clone_url="$1"
fi
